...
class Robot:
	...
	def set_cartesian2(self, pose):	
		poseCur = self.get_cartesian()
	...
	def flip_tool(self):
		...
		if (self.tool_pos==1 and joints[4]<45):
			joints[4]=joints[4]+90
		
		elif(self.tool_pos==0 and joints[4]>-45):
			joints[4]=joints[4]-90
	...
	def set_zone(self, 
		 ...
		 point_motion = False, 
		 manual_zone  = []):
		zone_dict = {'z0'  : [.3,.3,.03],'z1'  : [1,1,.1],'z5'  : [5,8,.8], 'z10' : [10,15,1.5],'z15' : [15,23,2.3],'z20' : [20,30,3], 'z30' : [30,45,4.5], 'z50' : [50,75,7.5], 'z100': [100,150,15], 'z200': [200,300,30]}
		'''
